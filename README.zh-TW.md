...
## 寫在最後
- Neo 的效能：為了實現全域的樣式改造，Neo 相比預設主題必然會消耗更多效能，主題已盡力最佳化效能（Neo+ 的 `performancetunning` 模組就是一個專門的效能最佳化模組）。但效能是一個多因素耦合的主觀感受，如果我們認為預設主題的流暢度為 1，Neo 的流暢度可能為 0.9，但如果使用了複雜的外掛、低效的程式碼片段，可能造成 0.9 × 0.9 = 0.81 的後果，此時把卡頓全部歸咎於主題是不合理的
